...
import { escapeJSKey } from '../utils/escapeJSKey'
import { convertComfyModuleAndNodeNameToCushyQualifiedNodeKey } from './_convertComfyModuleAndNodeNameToCushyQualifiedNodeKey'
import { getUnionNameBasedOnFirstFoundEnumName } from './_getUnionNameBasedOnFirstFoundEnumName'
...
export class ComfyUIObjectInfoParsed {
   ...
   constructor(
      ...
      public data: { spec: ComfySchemaJSON; embeddings: string[] },
   ) {
      this.onUpdate()
   }
   ...
   processSlot = (p: {
      ...
      if (unionInfo == null) {
         ...
         unionInfo = { hash, unionNameInCushy, values: enumValues, enumNames: [] }
