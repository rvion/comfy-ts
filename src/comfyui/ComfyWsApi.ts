...
export const PromptID$Schema = type.string.as<PromptID>()
...
// MISC -------------------------------------------------------------
export type NodeProgress = typeof NodeProgress_ark.infer
export const NodeProgress_ark = type({ value: 'number', max: 'number' })
