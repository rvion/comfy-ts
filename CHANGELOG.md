...
- **How many loras the picker draws is yours to set.** It stopped at 60 cards; the `… N more` line now carries the number, so you can raise it to 300 if your box and your collection are up to it. Kept in this browser, clamped to 1..2000 because every card is an image request.
